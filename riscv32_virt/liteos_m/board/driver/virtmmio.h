...
#define DMA_TO_VMM_ADDR(vaddr)              (vaddr)
#define IRQ_SPI_BASE                        RISCV_SYS_MAX_IRQ     

#define DSB                                 dsb()
#define FENCE_WRITE_UINT32(value, addr)     ({ DSB; *((volatile UINT32 *)((UINTPTR)(addr))) = (value); })
...
/* QEMU 5.2 virtio-mmio for riscv */
#define VIRTMMIO_BASE_ADDR                  0x10001000    /* see hw/riscv/virt.c virt_memmap[] */
#define VIRTMMIO_BASE_SIZE                  0x1000        /* see hw/riscv/virt.c virt_memmap[] */
#define VIRTMMIO_BASE_IRQ                   1             /* see hw/riscv/virt.h VIRTIO_IRQ */
#define NUM_VIRTIO_TRANSPORTS               8             /* see hw/riscv/virt.h VIRTIO_COUNT */
